...
function createSceneGraph(gl, resources) {
...

  {
    ...
    let floor = new MaterialSGNode(
                new ShadowTextureSGNode(renderTargetDepthTexture,2,
...
class ShadowTextureSGNode extends SGNode {
...
class ShadowSGNode extends SGNode {
  ...
  render(context) {
    ...
    // Hint: Look at the computation of lightViewProjectionMatrix to see how to multiply two matrices and
    // for the correct order of the matrices!
...
function renderToTexture(timeInMilliseconds)
{
  ...
  // Hint: compute the light's position in world space and let the light "shine"
  // towards the scene center (i.e. towards C3PO)
